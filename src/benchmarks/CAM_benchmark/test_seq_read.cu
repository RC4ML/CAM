...
static void run_task_function_test() {
    ...
    for(int i=0;i<10;i++){
            ...
            seq_read_submit(0, embed_num,(uintptr_t)gem_memory);
            //cam_gemm_read(embed_id, embed_num,(uintptr_t)gem_memory);
            //clear_wait_flag();
...
/*
nvcc -o test_seq_read  -I /home/szy/yzh_hyprion/spdk_interface  -L /home/szy/yzh_hyprion/spdk_interface -lgpussd_baseline test_seq_read.cu
*/