...
const int64_t embed_num = 300000;
...
static void run_task_function_test() {
    ...
    //launch_idle_kernel();
    void* gem_memory = alloc_gpu(1000000UL*10*4096);
    ...
    for(int i=0;i<10;i++){
            ...
            seq_write_submit(100, embed_num,(uintptr_t)gem_memory);
...
/*
nvcc -o test_seq_write  -I /home/szy/yzh_hyprion/spdk_interface  -L /home/szy/yzh_hyprion/spdk_interface -lgpussd_baseline test_seq_write.cu
*/